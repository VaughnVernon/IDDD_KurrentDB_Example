...
/**
 * Event emitted when a member is removed from a Team.
 */
export class TeamMemberRemoved extends DomainEvent {
    static with(
        tenant: Tenant,
        productId: ProductId,
        teamId: TeamId,
        ...
        return new TeamMemberRemoved(tenant.id, productId.id, teamId.id, memberId, memberType);
    }
