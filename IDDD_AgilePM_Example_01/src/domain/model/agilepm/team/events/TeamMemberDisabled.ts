...
/**
 * Event emitted when a member is disabled.
 */
export class TeamMemberDisabled extends DomainEvent {
    static with(
        tenant: Tenant,
        productId: ProductId,
        teamId: TeamId,
        ...
        return new TeamMemberDisabled(tenant.id, productId.id, teamId.id, memberId, memberType);
    }
