...
/**
 * Event emitted when the type of a BacklogItem is changed.
 */
export class BacklogItemTypeChanged extends DomainEvent {
    static with(
        tenant: Tenant,
        productId: ProductId,
        ...
        return new BacklogItemTypeChanged(tenant.id, productId.id, backlogItemId.id, type);
    }
