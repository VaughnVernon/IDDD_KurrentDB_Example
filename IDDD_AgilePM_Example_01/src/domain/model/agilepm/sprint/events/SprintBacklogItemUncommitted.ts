 ...
 */
export class SprintBacklogItemUncommitted extends DomainEvent {
    static with(
        tenant: Tenant,
        productId: ProductId,
        sprintId: SprintId,
        ...
        return new SprintBacklogItemUncommitted(tenant.id, productId.id, sprintId.id, backlogItemId.id);
    }
