...
/**
 * Entity representing a backlog item committed to a Sprint.
 * Embedded within the Sprint aggregate.
 */
export class CommittedBacklogItem {
    ...
    equals(other: CommittedBacklogItem): boolean {
